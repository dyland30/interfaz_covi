...
namespace MSSCargarClientes
{
...

    {
        ...
        public static BDGP GetInstance()
        {
            mMutex.WaitOne();
            if (mInstance == null)
            {
        ...
        private void Configurar()
        {
            try
            {
                this._CadenaConexion = ConfigurationManager.ConnectionStrings["CadenaConexionGP"].ConnectionString;
            }
